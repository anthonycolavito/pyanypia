"""Disability guarantee, child-care dropout years, and long low-earning
careers, penny-exact against the oracle."""
...
def test_special_case(spec: dict, expected: dict) -> None:
