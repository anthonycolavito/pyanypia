...
// $Id: WorkerDataGeneral.h 1.59 12/29/2025 12:57:04 Olson,DavidJ. $
...
public:
  ...
  /// <summary>Child care years, 1937 to 
...
public:
  ...
  ///
  /// <returns>Maximum year allowed (default <see cref="LASTYEARLR"/>).</returns>
