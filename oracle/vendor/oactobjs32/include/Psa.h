...
// $Id: Psa.h 1.37 8/26/2025 11:12:23 Olson,DavidJ. $
...
private:
   ...
   ///  years TRyear through LASTYEARLR, and 60 worker ages (16-75), and 60
   ...
   ///
   /// <remarks>Factors are for 3 sexes (male, female, and unisex), for the
   ///  years TRyear through LASTYEARLR, and 60 ages (16-75). Using these factors
