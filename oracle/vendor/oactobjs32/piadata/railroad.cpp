...
// $Id: railroad.cpp 1.41 8/26/2025 11:11:18 Olson,DavidJ. $
...
{
  if (year < YEAR37 || year > LASTYEARLR) {
    throw new PiaException(
      "Year of railroad earnings must be between 1951 and " + PunctFacet::getYear(LASTYEARLR));
  }
}
