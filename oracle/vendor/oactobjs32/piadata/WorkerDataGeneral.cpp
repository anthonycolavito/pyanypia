...
// $Id: WorkerDataGeneral.cpp 1.62 12/29/2025 12:56:08 Olson,DavidJ. $
...
// Maximum year of projection is <see cref="LASTYEARLR"/>, unless changed.
int WorkerDataGeneral::maxyear = LASTYEARLR;
